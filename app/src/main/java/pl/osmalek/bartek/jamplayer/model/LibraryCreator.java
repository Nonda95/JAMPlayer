...
class LibraryCreator {
    ...
    private static final String album = MediaStore.Audio.Albums.ALBUM;
    private static final String album_art = MediaStore.Audio.Albums.ALBUM_ART;
...
//    }
    ...
    private static LinkedList<MusicFile> getTracks(Context context) {
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            long album = cursor.getLong(cursor.getColumnIndex(LibraryCreator.songAlbumId));
            ...
            MusicFile file = new MusicFile(path.toString(), track_id, filename, path, artist, title, album, duration, trackNumber, "content://media/external/audio/media/" + track_id + "/albumart");
            files.add(file);
        }
        return files;
    }

//    private static Dictionary<Long, String> getAlbumsArt(Context context) {
